...
qk_tap_dance_action_t tap_dance_actions[] = {
		...
		[TD_NUMPAD] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_N, 5),
		[TD_PROGRAMMING] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_P, 6),
		[TD_GAMMING] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_G, 7) 
};
**/
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		...
		[_NUMBER] = LAYOUT_split_3x6_3(
						...
						KC_LSFT, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, 				KC_HOME, KC_PGDOWN, KC_PGUP, KC_END, KC_NO, KC_RSFT, 
		...
		[_SYMBOL] = LAYOUT_split_3x6_3(
						...
						LCTL_T(KC_ESC), KC_NO, X(sh), KC_NO, KC_LPRN, KC_LCBR, 		KC_RCBR, KC_RPRN, KC_SCLN, KC_QUOT, KC_BSLS, KC_GRV, 
						MO(4), X(zh), KC_NO, X(ch), KC_LBRC, KC_LT, 				KC_GT, KC_RBRC, KC_COMM, KC_DOT, KC_SLSH, KC_TILD, 
		...
		[_NUM_PAD] = LAYOUT_split_3x6_3(
						...
						LCTL_T(KC_ESC),KC_F6,KC_F7,KC_F8,KC_F9,KC_F10,				KC_4,KC_5,KC_6,KC_PLUS,KC_MINS,KC_EQL,
						KC_LSFT,KC_F11,KC_F12,KC_NO,KC_NO,KC_NO,					KC_7,KC_8,KC_9,KC_0,KC_COMM,KC_DOT,
